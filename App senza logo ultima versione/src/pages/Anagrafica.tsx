  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Anagrafica Trasgressori</h1>
          <p className="text-gray-600 dark:text-gray-400">Gestisci l'anagrafica completa dei trasgressori</p>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">
            Nessun trasgressore trovato
          </h3>
          <p className="text-gray-500 dark:text-gray-400 mb-4">
            Inizia aggiungendo il primo trasgressore all'anagrafica
          </p>
          <button className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200">
            Aggiungi Trasgressore
          </button>
        </div>
      </div>
    </div>
